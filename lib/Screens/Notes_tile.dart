                  ...
                  SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: ClipRRect(
                          ...
                          child: Image.asset("assests/images/Screenshot 2023-10-02 004023.png",fit: BoxFit.cover,)),
                    ),
                  ),
                  AnimatedContainer(
                      ...
                      children: [
                        ListTile(
                              ...
                              AutoSizeText(Subject[ind],style: GoogleFonts.exo(fontSize: size.height*0.038,color: Colors.black,fontWeight: FontWeight.w500),),
                                FloatingActionButton(
                                   ...
                                   setState(() {
                                    ...
                                    child:ispdfExpanded?Image.asset("assets/icon/download-button.png",height: size.height*0.03,):Image.asset("assests/images/pdf.png",height: size.height*0.03,),
                          ...
                          trailing:  FloatingActionButton(
                            ...
                            child:Image.asset("assets/icon/speech-bubble.png",height: size.height*0.05,),
                          ),
                       ...
                       isExpanded? Padding(
                         ...
                         child: Container(
                            ...
                            child: ListTile(
                              ...
                              trailing: FloatingActionButton(
                                child:Image.asset("assets/icon/brain.png",height: size.height*0.05,),
                                onPressed: (){
                                  setState(() {
