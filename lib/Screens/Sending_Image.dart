...
class SendImage extends StatefulWidget {
  const SendImage({super.key, required this.imagePath, required this.channel, required this.messageLength, required this.replyBoxHeight, required this.replyToName, required this.replyToText, required this.replyIndex});
