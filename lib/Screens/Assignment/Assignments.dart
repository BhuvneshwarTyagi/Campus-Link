...
import 'package:campus_link_teachers/Screens/Assignment/Assignment_Section.dart';
...
class _AssignmentsUploadState extends State<AssignmentsUpload> with TickerProviderStateMixin{
  ...
  List<Widget> tabScreen = [const AssignmentSection(),const LeaderBoard()];
  int currTab=0;
