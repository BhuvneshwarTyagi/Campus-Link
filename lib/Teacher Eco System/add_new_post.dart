...
class AddTeacherPost extends StatefulWidget {
  const AddTeacherPost({super.key,});
  @override
  State<AddTeacherPost> createState() => _AddTeacherPostState();
}

class _AddTeacherPostState extends State<AddTeacherPost> {
                      ...
                      onPressed: () async {
                        if(topicDescription.text.toString().isNotEmpty && topicController.text.toString().isNotEmpty)
                        {
                          Navigator.push(context, PageTransition(
                              ...
                              childCurrent: const AddTeacherPost(),
                          ...
                          if(filePath?.files[0].path != null)
                          {
                            ...
                            Reference imageDirectory=reference.child("Teachers Post");
                        ...
                        await FirebaseFirestore.instance.collection("Teachers Point")
                            .doc("Teachers Point")
                            .set({
                          usermodel["Email"].toString().split("@")[0]:1
                        }).whenComplete(() {
