...
class _QuizScreenState extends State<QuizScreen> with WidgetsBindingObserver{
        ...
        child: Container(
            ...
            child: Scaffold(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          '/${snap.data()?["Level-1"]["Answers"].length}',
                          style: TextStyle(
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: snap.data()?["Level-1"]["Answers"].length,
                      itemBuilder: (
                          context,
                          index2,
                          ) {
                        return Padding(
                          ...
                          child: SizedBox(
                            width: (size.width * 0.9 -
                                (size.width *
                                    0.01 *
                                    (snap.data()?["Level-1"]["Answers"].length - 1))) / snap.data()?["Level-1"]["Answers"].length,
                            child: Divider(
                              color: (count) > index2
                                  ? Colors.green
                                  : (count) ==index2
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        options=List.generate(snap
                            .data()?["Level-1"]["Options"]["${index+1}"].length, (index3) => snap.data()?["Level-1"]["Options"]["${index+1}"][index3]);
                        return Column(
                                    ...
                                    child: Column(
                                      children: [
                                        SizedBox(
                                          width: size.width * 1,
                                          child: AutoSizeText(
                                            "${index + 1}. ${snap.data()?["Level-1"]["Questions"]["${index+1}"]}",
                                            style: GoogleFonts.poppins(
                                        ...
                                        SizedBox(
                                          height: size.height * 0.081*snap.data()?["Level-1"]["Options"]["${index+1}"].length,
              ...
              floatingActionButton: FloatingActionButton.extended(
                onPressed: loaded && (count< snap.data()?["Level-1"]["Answers"].length-1)
                    ?
                    (){
                  setState(() {
                    if(selectedChoice[count]!="")
                    {
                      if(snap.data()?["Level-1"]["Answers"]["${optionIndex}"]==selectedOption[optionIndex])
                      {
                        score+=1;
                      }

                      count<snap.data()?["Level-1"]["Answers"].length-1?count++:null;
                  ...
                  if(selectedChoice[count]!="")
                  {
                    ...
                    await FirebaseFirestore.instance
                        ...
                        .doc(usermodel["Email"])
                        .update({
                      "${widget.subject}-record.Status" : score<8 ? "Failed" :"Certified",
                      "${widget.subject}-record.Level" : score<8 ? 0 : 3,
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) {
                        return Certificate(certificateName: widget.subject);
                      },));
                    });
                ...
                isExtended: true,
                heroTag: "dg",
                label: Text(loaded && (count< snap.data()?["Level-1"]["Answers"].length-1)
                    ?"Next" : "Submit"),
  ...
  fetchQuiz() async {
    await FirebaseFirestore.instance
      ...
      setState(() {
        selectedChoice=List.generate(snap.data()?["Level-1"]["Answers"].length, (index) =>"");
        print("...........${snap.data()?["Level-1"]["Answers"].length}");
        loaded = true;
      });
    });
  }
